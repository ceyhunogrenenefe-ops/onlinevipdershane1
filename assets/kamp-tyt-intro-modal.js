(function () {
  var SESSION_KEY = 'ovd_kamp_tyt_intro_session';
  var STORAGE_KEY = 'ovd_kamp_tyt_intro_dismissed';
  var REEL_ID = 'DIrsuaIiRb-';
  var EMBED_URL = 'https://www.instagram.com/reel/' + REEL_ID + '/embed';
  var POSTER_URL = '../assets/img/programlar/kamp-tyt-reel-thumb.jpg';
  ...
  function previewHtml() {
    return (
      ...
      '<h3>TYT yaz kampında neler yapıyoruz, öğrenmek ister misin?</h3>' +
      '<p>9 haftalık TYT yaz kampı programımızı kısa videoda izleyin; hızlandırma, deneme analizleri ve koçluk desteğini keşfedin.</p>' +
      '<button type="button" class="prog-video-preview-card" data-kamp-watch aria-label="TYT yaz kampı tanıtım videosunu izle">' +
      '<div class="prog-video-preview-thumb">' +
      '<img src="' + POSTER_URL + '" alt="TYT yaz kampı tanıtım videosu önizlemesi" loading="lazy" width="280" height="498">' +
