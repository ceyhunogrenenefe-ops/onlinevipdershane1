(function () {
  var SESSION_KEY = 'ovd_kamp_56_intro_session';
  var STORAGE_KEY = 'ovd_kamp_56_intro_dismissed';
  var REEL_ID = 'DJVs8DoC49d';
  var EMBED_URL = 'https://www.instagram.com/reel/' + REEL_ID + '/embed';
  var POSTER_URL = '../assets/img/programlar/kamp-56-reel-thumb.jpg';
  ...
  function previewHtml() {
    return (
      ...
      '<h3>5-6. sınıf yaz kampında neler yapıyoruz, öğrenmek ister misin?</h3>' +
      '<p>9 haftalık yaz kampı programımızı kısa videoda izleyin; matematik, fen bilimleri, kitap okuma atölyesi ve koçluk desteğini keşfedin.</p>' +
      '<button type="button" class="prog-video-preview-card" data-kamp-watch aria-label="5-6. sınıf yaz kampı tanıtım videosunu izle">' +
      '<div class="prog-video-preview-thumb">' +
      '<img src="' + POSTER_URL + '" alt="5-6. sınıf yaz kampı tanıtım videosu önizlemesi" loading="lazy" width="280" height="498">' +
