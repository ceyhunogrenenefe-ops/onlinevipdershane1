(function () {
  var SESSION_KEY = 'ovd_kamp_910_intro_session';
  var STORAGE_KEY = 'ovd_kamp_910_intro_dismissed';
  var REEL_ID = 'DJV1W_CCup-';
  var EMBED_URL = 'https://www.instagram.com/reel/' + REEL_ID + '/embed';
  var POSTER_URL = '../assets/img/programlar/kamp-910-reel-thumb.jpg';
  ...
  function previewHtml() {
    return (
      ...
      '<h3>9\'dan 10\'a geçişte neler yapıyoruz, öğrenmek ister misin?</h3>' +
      '<p>9 haftalık yaz kampı programımızı kısa videoda izleyin; matematik, fizik, kitap okuma atölyesi ve koçluk desteğini keşfedin.</p>' +
      '<button type="button" class="prog-video-preview-card" data-kamp-watch aria-label="9-10. sınıf yaz kampı tanıtım videosunu izle">' +
      '<div class="prog-video-preview-thumb">' +
      '<img src="' + POSTER_URL + '" alt="9-10. sınıf yaz kampı tanıtım videosu önizlemesi" loading="lazy" width="280" height="498">' +
